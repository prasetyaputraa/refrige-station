                ...
                <ul class="navbar-mobile__list list-unstyled">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                            <li>
                                <a href="log?log=1">Daily</a>
                            </li>
                            <li>
                                <a href="log?log=2">Weekly</a>
                            </li>
                            <li>
                                <a href="log?log=3">Monthly</a>
                            </li>
                            <li>
                                <a href="log?log=3">Yearly</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="menu-sidebar__content js-scrollbar1">
            <nav class="navbar-sidebar">
                <ul class="list-unstyled navbar__list">
                    ...
                    <li class="has-sub">
                        <a class="js-arrow" href="#">
                            <i class="fas fa-chart-bar"></i>Log</a>
                        <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                            <li>
                                <a href="log?log=1">Daily</a>
                            </li>
                        ...
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                ...
                                <button class="au-btn au-btn-icon au-btn--blue">
                                    send notification <i class="zmdi zmdi-mail-send"></i></button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="au-card-inner">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-top-countries">
                                                    <tbody>
                                                        @foreach($transaction['items'] as $drink)
                                                        <tr>
                                                            <td>{{$drink['name']}}</td>
                                                            ...
                                                            @else
                                                                <td>diambil</td>
                                                            @endif
                                                            <td class="text-right">{{ abs($drink['amount']) . ' botol' }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="au-card au-card--bg-blue au-card-top-countries m-b-40">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-top-countries">
                                                    <tbody>
                                                        @foreach($month['items'] as $drink)
                                                        <tr>
                                                            <td>{{$drink['name']}}</td>
                                                            <td>{{$drink['capacity'] . 'ml'}}</td>
                                                            <td class="text-right">{{ $drink['amount'] }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
...
<script src="{{ asset('js/vendor/counter-up/jquery.counterup.min.js') }}"></script>
